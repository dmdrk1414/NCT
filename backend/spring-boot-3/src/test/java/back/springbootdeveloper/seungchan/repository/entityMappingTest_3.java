...
class entityMappingTest_3 {
    ...
    void 매핑_저장_학습_테스트_1() throws Exception {
        데베_저장_유저_10_팀_1_학습_테스트(1);
    }

    void 데베_저장_유저_10_팀_1_학습_테스트(Integer number) throws Exception {
        // ================================== Club 1.Club 등록 ============================
        ...
        makeDbFlower(club, attendanceSate, clubGradeLeader, 1);
        makeDbFlower(club, attendanceSate, clubGradeDeputyLeader, 2);
        for (int i = number + 2; i <= number * 10; i++) {
            makeDbFlower(club, attendanceSate, clubGradeMember, i);
        }
    }

    private void makeDbFlower(Club club, AttendanceSate attendanceSate, ClubGrade clubGradeLeader, int i) {
        Member member = applyMember(i);

        // ================================= Member 21.ClubMemberInformation 등록 시작 ============================
        ClubMemberInformation clubMemberInformation = applyClubMemberInformation(i);
        ...
        ClubArticle clubArticle_suggestion = applyClubArticleCommentToClubArticle(SUGGESTION, i, clubMember);
    }
