...
public class ApiTest {
  ...
  public void tokenSetUp() throws Exception {
    ...
    attendanceStatus = attendanceStatusRepository.save(
        TestMakeObject.makeAttendanceStatus(user, vacationDates, absenceDates, weeklyData));
  ...
  public void 오성훈을위한테스트함수() throws Exception {
    ...
    attendanceStatus_3 = attendanceStatusRepository.save(
        TestMakeObject.makeAttendanceStatus(user_3, vacationDates_3, absenceDates_3, weeklyData_3));

    String vacationDates_5 = " 2023-08-07, 2023-08-11";
    String absenceDates_5 = "2023-08-15";
    String weeklyData_5 = "[1,1,0,-1,1]";
    attendanceStatus_5 = attendanceStatusRepository.save(
        TestMakeObject.makeAttendanceStatus(user_5, vacationDates_5, absenceDates_5, weeklyData_5));
  ...
  public void fetchSuggestionsTest() throws Exception {
    ...
    resultActions
        ...
        .andExpect(jsonPath("$.suggestionLists[0].classification").value(
            saveSuggestions.getClassification()))
        .andExpect(jsonPath("$.suggestionLists[0].title").value(saveSuggestions.getTitle()))
        .andExpect(jsonPath("$.suggestionLists[0].holidayPeriod").value(
            saveSuggestions.getHolidayPeriod()))
  ...
  public void writeSuggestionTest() throws Exception {
    ...
    assertThat(suggestionsList.get(0).getClassification()).isEqualTo(
        suggestionsRequest.getClassification());
    assertThat(suggestionsList.get(0).getTitle()).isEqualTo(suggestionsRequest.getTitle());
    assertThat(suggestionsList.get(0).getHolidayPeriod()).isEqualTo(
        suggestionsRequest.getHolidayPeriod());
  ...
  public void findAllYbUserTest() throws Exception {
    ...
    resultActions
        .andExpect(status().isOk())
        .andExpect(
            jsonPath("$.ybUserInfomationList[0].cntVacation").value(userUtill.getCntVacation()))
  ...
  public void findAllObUserTest() throws Exception {
    ...
    resultActions
        ...
        .andExpect(
            jsonPath("$[0].obUserList[0].yearOfRegistration").value(userOb.getYearOfRegistration()))
  ...
  public void AttendanceIsPassController() throws Exception {
    ...
    NumOfTodayAttendence numOfTodayAttendence = numOfTodayAttendenceList.get(
        numOfTodayAttendenceList.size() - 1);
  ...
  public void findVacationTest() throws Exception {
    ...
    AttendanceListFromJson attendanceListFromJson = objectMapper.readValue(responseStr,
        AttendanceListFromJson.class);
    // then
    resultActions
        .andExpect(jsonPath("$.absences").value(attendanceListFromJson.getAbsences()))
        .andExpect(
            jsonPath("$.beforeVacationDate").value(attendanceListFromJson.getBeforeVacationDate()))
  ...
  public void vacationCountTest() throws Exception {
    ...
    VacationCountRequest vacationCountRequest = new VacationCountRequest(addCntVacation,
        user.getId());
  ...
  public void newUserSignUpTest() throws Exception {
    ...
    boolean resultPassword = new BCryptPasswordEncoder().matches(name,
        newUserOfTempDb.getPassword());
  ...
  public void findNewUsersTest() throws Exception {
    ...
    result
        ...
        .andExpect(
            jsonPath("$.tempUser.yearOfRegistration").value(tempUserDB.getYearOfRegistration()))
...
//    }
  ...
  public void userExceptionAttendanceControlTest() throws Exception {
    ...
    boolean isExceptionAttendance = attendanceTimeRepository.findByUserId(1L)
