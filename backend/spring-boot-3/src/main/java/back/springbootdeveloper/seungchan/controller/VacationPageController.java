...
public class VacationPageController {
  ...
  @PostMapping("/request")
  public ResponseEntity<BaseResponseBody> applyVacation(
      @RequestBody VacationRequest vacationRequest, HttpServletRequest request) {
  ...
  @PostMapping("/count")
  public ResponseEntity<BaseResponseBody> vacationCount(
      @RequestBody VacationCountRequest vacationCountRequest, HttpServletRequest request) {
  ...
  public ResponseEntity<FindsVacationResponse> findsVacationRequest(HttpServletRequest request) {
    ...
    VacationsResponce vacationsResponce = attendanceService.findVacations(userId);
    FindsVacationResponse findsVacationResponse = new FindsVacationResponse(cntVacation,
        vacationsResponce);
  ...
  public ResponseEntity<AvailableApplyVacationResponse> applyVacationEachPerson(
