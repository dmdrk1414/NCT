...
public class UserInfo implements UserDetails {
  ...
  @Builder
  public UserInfo(String name, String phoneNum, String major, String gpa, String address,
  ...
  public UserInfo(String name, String phoneNum, String major, String gpa, String address,
      String specialtySkill, String hobby, String mbti, String studentId, String birthDate,
      String advantages, String disadvantage, String selfIntroduction, String photo, String email,
      String password) {
    this.name = name;
    this.phoneNum = phoneNum;
    this.major = major;
  ...
  public UserInfo(String name, String phoneNum, String major, String gpa, String address,
      String specialtySkill, String hobby, String mbti, String studentId, String birthDate,
      String advantages, String disadvantage, String selfIntroduction, String photo) {
    this.name = name;
    this.phoneNum = phoneNum;
    this.major = major;
    this.gpa = gpa;
