...
public class AuthenticationEmailService {
  ...
  public String sendSimpleMessage(String emailOfClient, String email) {
    ...
    String contentOfEmail = AuthenticationEmailMessageConstant.CONTENT_OF_EMAIL(email,
        tempPassword);

    //메세지를 생성하고 보낼 메일 설정 저장
    SimpleMailMessage messageFormOfEmail = getMessageFormOfEmail(emailOfClient, senderOfDeveloper,
        contentOfEmail, subjectOfEmail);
   ...
   * @return
   */
  private SimpleMailMessage getMessageFormOfEmail(String emailOfClient, String senderOfDeveloper,
      String contentOfEmail, String subjectOfEmail) {
  ...
  public void sendUserEmailMessage(String authenticationEmail, String email) {
    ...
    //메세지를 생성하고 보낼 메일 설정 저장
    SimpleMailMessage messageFormOfEmail = getMessageFormOfEmail(authenticationEmail,
        senderOfDeveloper, contentOfEmail, subjectOfEmail);
